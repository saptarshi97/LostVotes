...
public class SelectingParty extends AppCompatActivity {
    ...
    private void getVoteCountAndCastVote(){
        Log.d("TAG VAL", "inside getVoteCountAndCastVote: ");
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        if(document.get(PartyName)!=null){
                            ...
                            Log.d("TAG VAL", "onComplete: voutecount"+i);
                            castVote(i,PartyName);
                        }else {
                            Log.d("TAG VAL", "onComplete: voutecount: 0");
        ...
        Log.d("TAG VAL", "Finished getVoteCountAndCastVote: ");
    }
    ...
    private void castVote(int voteCount, String partyName){
        ...
        db.collection("VoteCount") //References the collection in the Db
                ...
                .update(vc)                  // adding the object to the db
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Log.d("TAG VAL", "onComplete: setVoteStatus");
                        setVoteStatus();
                    }
                })
    ...
    private void setVoteStatus(){
        Log.d("TAG VAL", "onComplete: inside setVoteStatus");
